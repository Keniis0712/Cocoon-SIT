...
const API_ERROR_KEY_BY_MESSAGE: Record<string, string> = {
  ...
  "Only bootstrap admin can reassign primary groups": "common:apiErrors.bootstrapAdminRequired",
  "Bootstrap admin required": "common:apiErrors.bootstrapAdminRequired",
  "Character not found": "common:apiErrors.characterNotFound",
  "Character access denied": "common:apiErrors.characterAccessDenied",
  "Character management denied": "common:apiErrors.characterAccessDenied",
  ...
  "Cocoon management denied": "common:apiErrors.cocoonAccessDenied",
